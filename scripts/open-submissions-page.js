/**
 * Script to directly open the BCR submissions page in a browser
 * This is a temporary solution to view the submissions page
 */
...
app.listen(PORT, () => {
  ...
  console.log(`\n==========================================================`);
  console.log(`BCR Submissions page is available at:`);
  console.log(`http://localhost:${PORT}/bcr/submissions`);
  console.log(`==========================================================\n`);
  console.log(`Please open the above URL in your browser to view the submissions page.`);
});
