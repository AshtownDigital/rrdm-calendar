...
exports.createUser = async (req, res) => {
  try {
    ...
    res.status(500).render('access/users/new', {
      title: 'New User',
      roles,
      formData: req.body,
...
exports.updateUser = async (req, res) => {
  try {
    ...
    res.status(500).render('access/users/edit', {
      title: 'Edit User',
...
exports.createRole = async (req, res) => {
  try {
    ...
    res.status(500).render('access/roles/new', {
      title: 'New Role',
      permissions,
      formData: req.body,
...
exports.updateRole = async (req, res) => {
  try {
    ...
    res.status(500).render('access/roles/edit', {
      title: 'Edit Role',
...
exports.listPermissions = async (req, res) => {
  try {
    ...
    res.render('access/permissions/list', {
      title: 'Permissions',
      permissions,
      filters: req.query,
      user: req.user
...
exports.newPermissionForm = async (req, res) => {
  try {
    res.render('access/permissions/new', {
...
exports.createPermission = async (req, res) => {
  try {
    ...
    res.status(500).render('access/permissions/new', {
      title: 'New Permission',
      formData: req.body,
...
exports.viewPermission = async (req, res) => {
  try {
    ...
    res.render('access/permissions/view', {
...
exports.editPermissionForm = async (req, res) => {
  try {
    ...
    res.render('access/permissions/edit', {
...
exports.updatePermission = async (req, res) => {
  try {
    ...
    res.status(500).render('access/permissions/edit', {
...
exports.forgotPasswordForm = async (req, res) => {
  try {
    res.render('access/forgot-password', {
...
exports.forgotPassword = async (req, res) => {
  try {
    ...
    res.render('access/forgot-password-success', {
...
exports.resetPassword = async (req, res) => {
  try {
    ...
    if (password !== confirmPassword) {
      return res.render('access/reset-password', {
        title: 'Reset Password',
        token,
