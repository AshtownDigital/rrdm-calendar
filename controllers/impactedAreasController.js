...
const create = async (req, res) => {
  try {
    ...
    res.render('bcr/impact-areas/confirm', {
    ...
    res.status(400).render('bcr/impact-areas/new', {
      title: 'New Impacted Area',
      nextOrder,
      formData: req.body,
      error: error.message,
...
const update = async (req, res) => {
  try {
    ...
    res.status(400).render('bcr/impact-areas/edit', {
...
const deleteArea = async (req, res) => {
  try {
    ...
    try {
      ...
      res.status(400).render('bcr/impact-areas/warning', {
