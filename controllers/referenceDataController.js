...
// Use the reference data model for all reference data operations
...
exports.listItems = async (req, res) => {
  try {
    ...
    res.render('ref-data/items/list', {
...
exports.createItem = async (req, res) => {
  try {
    ...
    res.status(500).render('ref-data/items/new', {
      title: 'New Reference Data Item',
      formData: req.body,
...
exports.viewItem = async (req, res) => {
  try {
    ...
    res.render('ref-data/items/view', {
...
exports.editItemForm = async (req, res) => {
  try {
    ...
    res.render('ref-data/items/edit', {
...
exports.updateItem = async (req, res) => {
  try {
    ...
    res.status(500).render('ref-data/items/edit', {
...
exports.deleteItemConfirm = async (req, res) => {
  try {
    ...
    res.render('ref-data/items/delete-confirm', {
...
exports.listValues = async (req, res) => {
  try {
    ...
    res.render('ref-data/values/list', {
...
exports.newValueForm = async (req, res) => {
  try {
    ...
    res.render('ref-data/values/new', {
...
exports.createValue = async (req, res) => {
  try {
    ...
    res.status(500).render('ref-data/values/new', {
      title: 'New Reference Data Value',
      items,
      formData: req.body,
...
exports.viewValue = async (req, res) => {
  try {
    ...
    res.render('ref-data/values/view', {
...
exports.editValueForm = async (req, res) => {
  try {
    ...
    res.render('ref-data/values/edit', {
...
exports.updateValue = async (req, res) => {
  try {
    ...
    res.status(500).render('ref-data/values/edit', {
...
exports.deleteValueConfirm = async (req, res) => {
  try {
    ...
    res.render('ref-data/values/delete-confirm', {
...
exports.listReleaseNotes = async (req, res) => {
  try {
    ...
    res.render('ref-data/release-notes/list', {
      title: 'Release Notes',
      releaseNotes,
      filters: req.query,
      user: req.user
...
exports.newReleaseNoteForm = async (req, res) => {
  try {
    res.render('ref-data/release-notes/new', {
...
exports.createReleaseNote = async (req, res) => {
  try {
    ...
    res.status(500).render('ref-data/release-notes/new', {
      title: 'New Release Note',
      formData: req.body,
...
exports.viewReleaseNote = async (req, res) => {
  try {
    ...
    res.render('ref-data/release-notes/view', {
...
exports.editReleaseNoteForm = async (req, res) => {
  try {
    ...
    res.render('ref-data/release-notes/edit', {
...
exports.updateReleaseNote = async (req, res) => {
  try {
    ...
    res.status(500).render('ref-data/release-notes/edit', {
...
exports.listRestorePoints = async (req, res) => {
  try {
    ...
    res.render('ref-data/restore-points/list', {
...
exports.createRestorePointForm = async (req, res) => {
  try {
    res.render('ref-data/restore-points/new', {
...
exports.createRestorePoint = async (req, res) => {
  try {
    ...
    res.status(500).render('ref-data/restore-points/new', {
      title: 'Create Restore Point',
      formData: req.body,
...
exports.viewRestorePoint = async (req, res) => {
  try {
    ...
    res.render('ref-data/restore-points/view', {
...
exports.restoreConfirm = async (req, res) => {
  try {
    ...
    res.render('ref-data/restore-points/restore-confirm', {
