...
router.get('/users/:userId', accessController.viewUser);
router.get('/users/:userId/edit', csrfProtection, accessController.editUserForm);
router.post('/users/:userId/edit', csrfProtection, accessController.updateUser);
...
router.get('/roles/:roleId', accessController.viewRole);
router.get('/roles/:roleId/edit', csrfProtection, accessController.editRoleForm);
router.post('/roles/:roleId/edit', csrfProtection, accessController.updateRole);
...
router.get('/permissions/:permissionId', accessController.viewPermission);
router.get('/permissions/:permissionId/edit', csrfProtection, accessController.editPermissionForm);
router.post('/permissions/:permissionId/edit', csrfProtection, accessController.updatePermission);
...
router.get('/reset-password/:resetToken', accessController.resetPasswordForm);
router.post('/reset-password/:resetToken', csrfProtection, accessController.resetPassword);
