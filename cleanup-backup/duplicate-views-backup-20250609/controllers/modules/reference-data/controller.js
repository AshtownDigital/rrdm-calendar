...
exports.dashboard = async (req, res) => {
  try {
    ...
    res.render('reference-data/dashboard', {
...
exports.listItems = async (req, res) => {
  try {
    ...
    res.render('reference-data/items/list', {
...
exports.newItemForm = async (req, res) => {
  try {
    res.render('reference-data/items/new', {
...
exports.createItem = async (req, res) => {
  try {
    ...
    res.status(500).render('reference-data/items/new', {
      title: 'New Reference Data Item',
      formData: req.body,
...
exports.viewItem = async (req, res) => {
  try {
    ...
    res.render('reference-data/items/view', {
...
exports.editItemForm = async (req, res) => {
  try {
    ...
    res.render('reference-data/items/edit', {
...
exports.updateItem = async (req, res) => {
  try {
    ...
    res.status(500).render('reference-data/items/edit', {
...
exports.deleteItemConfirm = async (req, res) => {
  try {
    ...
    res.render('reference-data/items/delete-confirm', {
...
exports.listValues = async (req, res) => {
  try {
    ...
    res.render('reference-data/values/list', {
...
exports.newValueForm = async (req, res) => {
  try {
    ...
    res.render('reference-data/values/new', {
...
exports.createValue = async (req, res) => {
  try {
    ...
    res.status(500).render('reference-data/values/new', {
      title: 'New Reference Data Value',
      items,
      formData: req.body,
...
exports.viewValue = async (req, res) => {
  try {
    ...
    res.render('reference-data/values/view', {
...
exports.editValueForm = async (req, res) => {
  try {
    ...
    res.render('reference-data/values/edit', {
...
exports.updateValue = async (req, res) => {
  try {
    ...
    res.status(500).render('reference-data/values/edit', {
...
exports.deleteValueConfirm = async (req, res) => {
  try {
    ...
    res.render('reference-data/values/delete-confirm', {
...
exports.listReleaseNotes = async (req, res) => {
  try {
    ...
    res.render('reference-data/release-notes/list', {
      title: 'Release Notes',
      releaseNotes,
      filters: req.query,
      user: req.user
...
exports.newReleaseNoteForm = async (req, res) => {
  try {
    res.render('reference-data/release-notes/new', {
...
exports.createReleaseNote = async (req, res) => {
  try {
    ...
    res.status(500).render('reference-data/release-notes/new', {
      title: 'New Release Note',
      formData: req.body,
...
exports.viewReleaseNote = async (req, res) => {
  try {
    ...
    res.render('reference-data/release-notes/view', {
...
exports.editReleaseNoteForm = async (req, res) => {
  try {
    ...
    res.render('reference-data/release-notes/edit', {
...
exports.updateReleaseNote = async (req, res) => {
  try {
    ...
    res.status(500).render('reference-data/release-notes/edit', {
...
exports.listRestorePoints = async (req, res) => {
  try {
    ...
    res.render('reference-data/restore-points/list', {
...
exports.createRestorePointForm = async (req, res) => {
  try {
    res.render('reference-data/restore-points/new', {
...
exports.createRestorePoint = async (req, res) => {
  try {
    ...
    res.status(500).render('reference-data/restore-points/new', {
      title: 'Create Restore Point',
      formData: req.body,
...
exports.viewRestorePoint = async (req, res) => {
  try {
    ...
    res.render('reference-data/restore-points/view', {
...
exports.restoreConfirm = async (req, res) => {
  try {
    ...
    res.render('reference-data/restore-points/restore-confirm', {
